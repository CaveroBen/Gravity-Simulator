...
def test_center_of_mass_conservation():
    ...
    assert drift_1d < 1e-10, f"1D: Center of mass drifted by {drift_1d}"
    ...
    assert drift_2d_sq < 1e-10, f"2D Square: Center of mass drifted by {drift_2d_sq}"
    ...
    assert drift_2d_tri < 1e-10, f"2D Triangular: Center of mass drifted by {drift_2d_tri}"
